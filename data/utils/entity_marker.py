...
if __name__ == "__main__":
    ...
    # test_df = train[:100]
    # entity_marker_type = "typed_entity_marker_punc_3"

    # temp = get_entity_marked_dataframe(entity_marker_type, test_df)

    # tokenizer = AutoTokenizer.from_pretrained("klue/roberta-large", add_special_tokens = True)

    # text = temp.iloc[72]["sentence"]
    # tokenized_text = tokenizer.tokenize(text, add_special_tokens=False)
    # print(tokenized_text)

    # added_token_num, tokenizer = add_special_tokens(entity_marker_type, tokenizer)
    # tokenized_text = tokenizer.tokenize(text, add_special_tokens=False)
    # print(tokenized_text)
