...
def tokenized_dataset(sentences, tokenizer, subject_entities, object_entities):
    ...
    concat_entity = [
        e01 + "[SEP]" + e02 for e01, e02 in zip(subject_entities, object_entities)
    ]
...
class RE_Collator(object):
    ...
    def __call__(self, batch):
        ...
        # tokenization
        tokenized_dict = tokenized_dataset(
            sentences, self.tokenizer, subject_entities, object_entities
        )
